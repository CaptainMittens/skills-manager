...
export const importProjectSkillToCenter = (
  ...
  invoke<void>('import_project_skill_to_center', {
    projectId,
    skillRelativePath,
    agent,
  })
...
export const exportSkillToProject = (
  ...
  invoke<void>('export_skill_to_project', {
    skillId,
    projectId,
    agents: agents ?? null,
  })
...
export const updateProjectSkillToCenter = (
  ...
  invoke<void>('update_project_skill_to_center', {
    projectId,
    skillRelativePath,
    agent,
  })
...
export const getGlobalLocalSkillDocument = (
  ...
  invoke<ProjectSkillDocument>('get_global_local_skill_document', {
    agent,
    skillRelativePath,
  })
...
export const importGlobalLocalSkillToCenter = (
  ...
  invoke<void>('import_global_local_skill_to_center', {
    agent,
    skillRelativePath,
  })
...
export const updateGlobalLocalSkillFromCenter = (
  ...
  invoke<void>('update_global_local_skill_from_center', {
    agent,
    skillRelativePath,
  })
