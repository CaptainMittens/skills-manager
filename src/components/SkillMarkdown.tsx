...
export function SkillMarkdown({ content, className }: SkillMarkdownProps) {
  ...
  return (
    <article
      className={cn(
        'mx-auto w-full max-w-[1240px] text-[13px] leading-6 text-secondary',
        className,
      )}
    >
      <ReactMarkdown
        ...
        components={{
          h1: ({ className, ...props }) => (
            <h1
              className={cn(
                'mb-4 text-[28px] font-semibold leading-tight text-primary',
                className,
              )}
              {...props}
            />
          ...
          h2: ({ className, ...props }) => (
            <h2
              className={cn(
                'mb-3 mt-8 text-[20px] font-semibold leading-tight text-primary',
                className,
              )}
              {...props}
            />
          ...
          h3: ({ className, ...props }) => (
            <h3
              className={cn(
                'mb-2 mt-6 text-[16px] font-semibold leading-tight text-primary',
                className,
              )}
              {...props}
            />
          ...
          p: ({ className, ...props }) => (
            <p
              className={cn(
                'mb-4 text-[13px] leading-6 text-secondary',
                className,
              )}
              {...props}
            />
          ...
          a: ({ className, href, ...props }) => {
            ...
            const safeHref =
              href && !dangerous.test(href.trim()) ? href : undefined
            return (
              <a
                className={cn(
          ...
          ul: ({ className, ...props }) => (
            <ul
              className={cn(
                'mb-4 list-disc space-y-1 pl-5 text-secondary',
                className,
              )}
              {...props}
            />
          ...
          ol: ({ className, ...props }) => (
            <ol
              className={cn(
                'mb-4 list-decimal space-y-1 pl-5 text-secondary',
                className,
              )}
              {...props}
            />
          ...
          li: ({ className, ...props }) => (
            <li
              className={cn('pl-1 marker:text-muted', className)}
              {...props}
            />
          ),
          ...
          code: ({ className, children, ...props }) => {
            ...
            if (isBlock) {
              return (
                <code
                  className={cn(
                    'block text-[13px] leading-6 text-secondary',
                    className,
                  )}
                  {...props}
                >
          ...
          table: ({ className, ...props }) => (
            <div className="mb-4 overflow-x-auto rounded-xl border border-border-subtle">
              <table
                className={cn(
                  'min-w-full border-collapse text-left text-[13px]',
                  className,
                )}
                {...props}
              />
          ...
          thead: ({ className, ...props }) => (
            <thead
              className={cn('bg-surface-hover text-primary', className)}
              {...props}
            />
          ),
          th: ({ className, ...props }) => (
          ...
          td: ({ className, ...props }) => (
            <td
              className={cn(
                'border-b border-border-subtle px-3 py-2 text-secondary',
                className,
              )}
              {...props}
            />
