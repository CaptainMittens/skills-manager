...
export function Settings() {
  ...
  useEffect(() => {
    ...
    api.getSettings('skillsmp_api_key').then((v) => {
      if (v) setSkillsmpApiKey(v)
    })
    api
      .getCentralRepoPath()
      .then((path) => {
              ...
              <div className="flex items-center gap-2">
                ...
                <h3
                  className={cn(
                    ...
                    agent.installed ? 'text-secondary' : 'text-muted',
                  )}
                >
                  {agent.display_name}
                </h3>
  ...
  return (
    <div className="app-page app-page-narrow">
      ...
      <div className="space-y-6">
            ...
            <div className="app-panel p-4 mb-3 space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-muted hover:text-secondary outline-none"
                >
              ...
              <div className="flex justify-end">
                <button
                  ...
                  disabled={
                    addingCustom || !customName.trim() || !customPath.trim()
                  }
            ...
            {secondaryTools.length > 0 && (
              <div>
                ...
                >
                  ...
                  {t('settings.moreAgentsSection', {
                    count: secondaryTools.length,
                  })}
                </button>
                {showMoreAgents && (
                  <AgentGroupDnd
        ...
        <section>
          ...
          <div className="app-panel overflow-hidden divide-y divide-border-subtle">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 px-4 py-3">
              <div className="min-w-0 flex-1">
                <h3 className="text-[13px] text-secondary font-medium mb-0.5">
                  {t('settings.defaultScenario')}
                </h3>
                <p className="text-[13px] text-muted">
                  {t('settings.defaultScenarioDesc')}
                </p>
              </div>
        ...
        <section>
          <h2 className="app-section-title mb-3">
            {t('settings.skillsmpTitle', {
              defaultValue: 'SkillsMP AI Search',
            })}
          </h2>
          <div className="app-panel overflow-hidden divide-y divide-border-subtle">
            <div className="px-4 py-3">
              <h3 className="text-[13px] text-secondary font-medium mb-0.5">
                {t('settings.skillsmpApiKey', { defaultValue: 'API Key' })}
              </h3>
              <p className="text-[13px] text-muted mb-2">
                {t('settings.skillsmpDesc', {
                  defaultValue:
                    'Enter your SkillsMP API key to enable AI-powered skill search.',
                })}{' '}
                <button
                  type="button"
                ...
                >
                  {t('settings.skillsmpGetKey', {
                    defaultValue: 'Get your API key',
                  })}
