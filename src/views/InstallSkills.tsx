...
export function InstallSkills() {
  ...
  useEffect(() => {
    api
      .getSettings('skillsmp_api_key')
      .then((v) => setSkillsmpApiKey(v || null))
  }, [])
  ...
  const handleBatchImportFolder = async () => {
    ...
    try {
      ...
      if (result.errors.length > 0) {
        ...
        const detail =
          remaining > 0 ? `${previewErrors}; +${remaining} more` : previewErrors
        toast.error(
                ...
                <div className="flex flex-col gap-1.5 lg:flex-row lg:items-center">
                  ...
                  <div className="relative flex-1 lg:max-w-[640px]">
                    ...
                    <input
                      ...
                      placeholder={
                        aiSearch
                          ? t('install.aiSearchPlaceholder', {
                              defaultValue:
                                'AI search — describe what you need...',
                            })
                          : t('install.searchMarket')
                      }
                  ...
                  <button
                    onClick={() => {
                      if (skillsmpApiKey) {
                        ...
                        toast.info(
                          t('install.aiSearchNoKey', {
                            defaultValue:
                              'Set your SkillsMP API key in Settings to enable AI search',
                          }),
                          {
                            action: {
                    ...
                    title={t('install.aiSearchToggle', {
                      defaultValue: 'AI-powered search (SkillsMP)',
                    })}
                  >
                ...
                <>
                  <div className="app-panel-muted overflow-hidden">
                    {scanGroups.map((group) => {
                      const [primaryLocation, ...otherLocations] =
                        group.locations
